...
export default function StudentManagement() {
  ...
  // --- Filtered list for de-register tab ---
        ...
        <div className="sm-header">
          ...
          <div>
            ...
            <p className="sm-subtitle">
              Manage the Hosteller registry — students not in the list are automatically treated as Day-Scholars.
            </p>
          </div>
        </div>
