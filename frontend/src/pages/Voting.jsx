...
const API = `${import.meta.env.VITE_API_URL || 'http://localhost:5000'}/api/polls`;
...
export default function Voting() {
  ...
  useEffect(() => {
    ...
    axios.get(`${import.meta.env.VITE_API_URL || 'http://localhost:5000'}/api/auth/settings?studentId=${u.id || u._id}`)
      .then(res => {
